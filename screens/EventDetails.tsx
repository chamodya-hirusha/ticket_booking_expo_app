...
const EventDetails = () => {
  ...
  const getMinPrice = () => {
    ...
    return `Starts at $${minPrice.toFixed(0)}`;
  };
      ...
      try {
        ...
        if (response.success && response.data) {
          ...
          const transformedEvent: Event = {
            ...
            image: eventData.imageUrl || eventData.image_url || eventData.image || null,
          };
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={styles.content}>
          ...
          {/* Ticket Information */}
          {(event.generalTicketPrice > 0 ||
            event.premiumTicketPrice > 0 ||
            event.vipTicketPrice > 0) && (
            <View
              style={[
                styles.aboutSection,
                {
                ...
                {event.generalTicketPrice > 0 && (
                  <View style={styles.ticketRow}>
                    ...
                    <Text style={[styles.ticketPrice, { color: colors.primary }]}>
                      ${event.generalTicketPrice.toFixed(2)}
                    </Text>
                  </View>
                )}
                {event.premiumTicketPrice > 0 && (
                  <View style={styles.ticketRow}>
                    ...
                    <Text style={[styles.ticketPrice, { color: colors.primary }]}>
                      ${event.premiumTicketPrice.toFixed(2)}
                    </Text>
                  </View>
                )}
                {event.vipTicketPrice > 0 && (
                  <View style={styles.ticketRow}>
                    ...
                    <Text style={[styles.ticketPrice, { color: colors.primary }]}>
                      ${event.vipTicketPrice.toFixed(2)}
                    </Text>
                  </View>
                )}
              </View>
